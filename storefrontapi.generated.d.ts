...
export type LayoutQueryVariables = StorefrontAPI.Exact<{
  ...
  headerSecondaryMenuHandle: StorefrontAPI.Scalars['String'];
  footerMenuHandle: StorefrontAPI.Scalars['String'];
  mobileMenuHandle: StorefrontAPI.Scalars['String'];
  connectHandle: StorefrontAPI.Scalars['String'];
}>;
...
export type LayoutQuery = {
  ...
  >;
  headerSecondaryMenu?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Menu, 'id'> & {
      items: Array<
        Pick<
          StorefrontAPI.MenuItem,
  ...
  footerMenu?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Menu, 'title' | 'id'> & {
      items: Array<
        Pick<
          StorefrontAPI.MenuItem,
          'id' | 'resourceId' | 'tags' | 'title' | 'type' | 'url'
...
export type CartDiscountCodesUpdateMutationVariables = StorefrontAPI.Exact<{
  ...
  discountCodes?: StorefrontAPI.InputMaybe<
    Array<StorefrontAPI.Scalars['String']> | StorefrontAPI.Scalars['String']
  >;
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
}>;
...
export type CollectionDetailsQueryVariables = StorefrontAPI.Exact<{
  ...
  namespace: StorefrontAPI.Scalars['String'];
  key: StorefrontAPI.Scalars['String'];
}>;
...
export type CollectionDetailsQuery = {
  collection?: StorefrontAPI.Maybe<
    ...
    > & {
      metafields: Array<
        StorefrontAPI.Maybe<
          Pick<StorefrontAPI.Metafield, 'key' | 'namespace' | 'value' | 'id'>
        >
      >;
