...
export const INPUT_STYLE_CLASSES =
  'appearance-none dark:bg-transparent text-copy lg:text-lead border focus:border-[#d6d6d6] focus:ring-0 w-full py-4 px-6 text-primary/90 placeholder:text-primary/50 leading-tight';

export const getInputStyleClasses = (isError?: string | null) => {
  return `${INPUT_STYLE_CLASSES} ${
    isError ? 'border-red-500' : 'border-[#d6d6d6]'
  }`;
};
