...
async function getLayoutData({storefront}: AppLoadContext) {
  const data = await storefront.query(LAYOUT_QUERY, {
    variables: {
      ...
      headerSecondaryMenuHandle: 'secondary-menu',
      footerMenuHandle: 'footer-menu',
      mobileMenuHandle: 'menu-mobile',
  ...
  */
  ...
  const headerSecondaryMenu = data?.headerSecondaryMenu
    ? parseMenu(data.headerSecondaryMenu, customPrefixes)
    : undefined;
  ...
  const mobileMenu = data?.mobileMenu
    ? parseMenu(data.mobileMenu, customPrefixes)
    : undefined;

  const connect = data?.connect
    ? parseMenu(data.connect, customPrefixes)
    : undefined;
