...
export default function Search() {
  ...
  return (
    <>
      <PageHeader className=" my-[2rem] px-[3rem] py-[3.5rem] md:mt-[5rem] md:mb-[6rem] md:pt-[5rem] md:pb-[7rem]">
        <Heading
          as="h1"
          className="search-result_heading font-heading md:text-[4.8rem] mt-[4rem] mb-0"
          size="copy"
        >
